...
public class ExpressionParser {
        ...
        while(!tokenQueue.isEmpty()){
            ...
            //If token is a valid operator
                ...
                if (!tokenQueue.isEmpty() && tokenQueue.peek().equals("(")){
                    ...
                    return StaticParameterCenter.funcCall;
                }
                ...
                if(opStack.isEmpty()){ //If there is not corresponding left bracket.
                    return StaticParameterCenter.unevenBrackets;
                }
                ...
                //If there's a non operator value directly after then brackets, multiply!
                ...
                while (!opStack.isEmpty() && testPrecedence(token)){
                    if (valueStack.size() < 2){
                        return StaticParameterCenter.missingVal;
                    }
     ...
     *
     * @param resultTemp
     * @return the verified result, or a specific StaticParameterCenter message
     */
    private static String verifyResult(String resultTemp){
        ...
        if (resultTemp == null){   // If no operands have been entered
            ...
            return StaticParameterCenter.undefined;
        }
        else if(resultTemp.matches("Infinity|-Infinity")){
            return StaticParameterCenter.outOfRange;
        }
        else if(!valueStack.isEmpty()){
            return StaticParameterCenter.missingOp;
        }
