 ...
 * Author: Chao Wang
 * This class is based on ArrayList, but adding constaint of Array Bound is fixed.
 * Also the inserting element will always be the first element.
 */
...
public class BoundedArrayList<E> extends AbstractList<E>{
    ...
    /**
     *
     * @param index target index want to insert into
    ...
    /**
     * add method, this will always add object to the 0 index of array
     * @param object
     * @return
     */
    @Override
    public boolean add(E object) {
        Object[] a = array;
        int s = size;
        // if array is full, remove the last one, shift to the right.
        if (capacity == s) {
            System.arraycopy(a, 0, a, 1, s-1);
            array = a ;
        }
        // if array is not full, clean up the first space, shift everything to right.
        else  {
    ...
    /**
     * getter to get the element in the index of array.
     * @param index
     * @return
     */
    ...
    /**
     * remove the element at the index of array.
     * @param index
     * @return
     */
