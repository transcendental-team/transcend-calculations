 ...
 * Author: Chao Wang
 * Reference https://github.com/shardul/Android/tree/master/ChromeStyleHelpPopups
 * Original authoer: Shardul Prabhu
 * This class create the pop up window to display the information in the long press event
 */
...
public class ChromeHelpPopup {
    ...
    public ChromeHelpPopup(Context context, String text, int viewResource) {
        ...
        mHelpTextView = (TextView) mView.findViewById(R.id.blue_text);
